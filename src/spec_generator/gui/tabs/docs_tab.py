...
class DocsTab(BaseTab):
    def create_widgets(self):
        ...
        docs_content = [
            ...
            ("Peptide Mapping Tab\n", "bold"),
            ("This tab performs an in-silico digestion of a protein sequence and simulates the resulting peptide map. It predicts peptide retention times and generates a full chromatogram (LC-MS data) as an .mzML file. You can preview the Base Peak Chromatogram (BPC) before generating the full file.\n\n", "body"),
            ("Antibody Simulation Tab\n", "bold"),
            ("This tab is specialized for simulating intact antibody spectra. You can define multiple heavy and light chains, specify modifications like pyro-glutamate or C-terminal lysine loss, and configure various PTMs. The tool automatically generates all possible assembly combinations (e.g., 2HC+2LC, 2HC+1LC) and their theoretical masses, allowing you to set their relative abundances before simulation.\n\n", "body"),
            ("Advanced Parameters\n", "h2"),
